...
func TestBuildFilter(t *testing.T) {
	...
	got := buildFilter([]rules.Range{
		{First: rules.IP2U(net.ParseIP("10.10.10.0")), Last: rules.IP2U(net.ParseIP("10.10.10.255"))},
	}, 55043)
	want := "(outbound and tcp and ((ip.DstAddr >= 10.10.10.0 and ip.DstAddr <= 10.10.10.255)))" +
	...
	if !strings.Contains(got, "ip.DstAddr >= 10.10.10.0 and ip.DstAddr <= 10.10.10.255 and (tcp.DstPort == 443 or (tcp.DstPort >= 8000 and tcp.DstPort <= 9000))") {
